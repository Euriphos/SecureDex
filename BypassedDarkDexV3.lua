...
loadstring(
    game:HttpGet(
        'https://raw.githubusercontent.com/Euriphos/SecureDex/refs/heads/main/CloneRef.lua',
        true
    )
)()
...
loadstring(
    game:HttpGet(
        'https://raw.githubusercontent.com/Euriphos/SecureDex/refs/heads/main/Bypasses.lua',
        true
    )
)()
...
for _,v in pairs(Bypassed_Dex:GetDescendants()) do 
    if v:IsA("LocalScript") and tostring(v.Parent) == "ExplorerPanel" then  
        v.Source = game:HttpGet("https://raw.githubusercontent.com/Euriphos/SecureDex/refs/heads/main/Dex.lua")
    end 
end       
...
local function Load(Obj, Url)
    ...
    local function LoadScripts(Script)
        if
            ...
            or Script.ClassName == 'LocalScript'
        then
            task.spawn(
                GiveOwnGlobals(
                    loadstring(Script.Source, '=' .. Script:GetFullName()),
                    Script
                )
            )
        end
